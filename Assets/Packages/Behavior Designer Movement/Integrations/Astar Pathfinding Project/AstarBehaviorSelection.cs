...
public class AstarBehaviorSelection : MonoBehaviour
{
    ...
    private enum BehaviorSelectionType { Seek, Flee, Pursue, Evade, Follow, Patrol, Cover, Wander, Search, Flock, LeaderFollow, Queue, Last }
	...
	private string Description()
    {
        ...
        switch (selectionType) {
            ...
            case BehaviorSelectionType.Flock:
                desc = "The Flock task moves a group of objects together in a pattern (which can be adjusted). In this example the Flock task is controlling all 30 objects.";
                break;
            case BehaviorSelectionType.LeaderFollow:
                desc = "The Leader Follow task moves a group of objects behind a leader object. There are two behavior trees running in this example - one for the leader (who is patrolling the area) and one for the group of objects.";
                break;
    ...
    private void SelectionChanged()
    {
        ...
        switch (selectionType) {
            case BehaviorSelectionType.Seek:
                ...
                mainBot.transform.position = new Vector3(-20, 2, -20);
            ...
            case BehaviorSelectionType.Flee:
                ...
                mainBot.transform.position = new Vector3(10, 2, 18);
                mainBot.transform.eulerAngles = new Vector3(0, 180, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
            case BehaviorSelectionType.Pursue:
                ...
                mainBot.transform.position = new Vector3(-20, 2, 0);
            ...
            case BehaviorSelectionType.Evade:
                ...
                mainBot.transform.position = new Vector3(0, 2, 18);
                mainBot.transform.eulerAngles = new Vector3(0, 180, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
            ...
            case BehaviorSelectionType.Patrol:
                ...
                break;
            case BehaviorSelectionType.Cover:
                mainBot.transform.position = new Vector3(-5, 2, -10);
                mainBot.transform.eulerAngles = new Vector3(0, 0, 0);
                mainBot.SetActive(true);
                StartCoroutine("EnableBehavior");
                break;
