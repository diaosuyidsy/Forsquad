...
public class Skill_1_HitScan : MonoBehaviour
{
    ...
    public GameObject GunTip;                       // Tip of a gun
    ...
    void Awake ()
    {
        ...
        gunLight = GunTip.GetComponent<Light> ();
    }
    ...
    private void Shoot ()
    {
        ...
        if (shootHit.collider != null)
        {
            ...
            float distance = shootHit.transform.position.y - GunTip.transform.position.y;
            gunLine.SetPosition (1, new Vector2 (0, Vector2.Distance (shootHit.point, GunTip.transform.position) / 2));
